sap.ui.define([
		...
		return BaseObject.extend("opt1.model.ListSelector", {
			 ...
			 * @return {opt1.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
