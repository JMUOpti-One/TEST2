							...
							success : function (aEntitySet) {
								...
								return this.waitFor({
									...
									check: function (oList) {
										...
										var sObjectID = oList.getBindingContext().getProperty("EntryB1EDI");

										var iLength = aEntitySet.filter(function (oLineItem) {
											return oLineItem.EntryB1EDI === sObjectID;
										}).length;
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								return this.waitFor({
									id : "lineItemsHeader",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name: "text", value: "Lines (" + iNumberOfItems + ")"}),
									success : function () {
